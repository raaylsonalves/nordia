...
/* eslint-disable react-hooks/set-state-in-effect, @next/next/no-img-element -- vendored from react-bits; kept close to
   upstream so it can be re-pulled, rather than rewritten to our rules. */
...
const DriftWall = ({
  ...
  overlayColor = '#060010',
  className = '',
  // defaulted on top of the react-bits source: TS reads it as required
  style = undefined
}) => {
